...
namespace SwimTimeTracker.Data.Migrations
{
    ...
    [Migration("20170711101920_raceAdd")]
    partial class raceAdd
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SwimTimeTracker.Models.Event", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SwimTimeTracker.Models.Race", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SwimTimeTracker.Models.Race", b =>
                {
                    b.HasOne("SwimTimeTracker.Models.Event", "Event")
                        .WithMany()
                        .HasForeignKey("EventID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SwimTimeTracker.Models.Swimmer", "Swimmer")
                        .WithMany()
